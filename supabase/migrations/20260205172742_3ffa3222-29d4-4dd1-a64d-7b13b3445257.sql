-- Update void_receipt to lookup user_id from users table
...
DECLARE
  ...
  v_user_id uuid;
BEGIN
  -- Lookup the public.users.user_id from auth_id
  SELECT user_id INTO v_user_id
  FROM public.users
  WHERE auth_id = p_voided_by;
...
-- Update void_sale to lookup user_id from users table
